...
| 12 | **Mutation + license gates on this repo**: export Stryker.NET config and the license gate from the goldpath/specdrift script set once the parity comparator (the first calculation core worth mutating) lands. | CI pipeline |
